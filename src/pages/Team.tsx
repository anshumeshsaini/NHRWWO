...
import board12 from "../assets/teams/teamimg12.jpeg";
import board13 from "../assets/teams/teamimg13.jpeg";
import board14 from "../assets/teams/teamimg14.jpeg";
import board15 from "../assets/teams/teamimg15.jpeg";
import board16 from "../assets/teams/teamimg16.jpeg";
import board17 from "../assets/teams/teamimg17.jpeg";
...
import youth33 from "../assets/member/youth/youth33.jpeg";
import youth34 from "../assets/member/youth/youth34.jpeg";
import youth36 from "../assets/member/youth/youth36.jpeg";
import youth37 from "../assets/member/youth/youth37.jpeg";
import youth38 from "../assets/member/youth/youth38.jpeg";
import youth39 from "../assets/member/youth/youth39.jpeg";
import youth40 from "../assets/member/youth/youth40.jpeg";
import youth41 from "../assets/member/youth/youth41.jpeg";
import youth42 from "../assets/member/youth/youth42.jpeg";
import youth43 from "../assets/member/youth/youth43.jpeg";
import youth44 from "../assets/member/youth/youth44.jpeg";
import youth45 from "../assets/member/youth/youth45.jpeg";
import youth46 from "../assets/member/youth/youth46.jpeg";
import youth47 from "../assets/member/youth/youth47.jpeg";
...
const Team = () => {
  ...
  const boardMembers = [
    ...
    {
    name: "Sarita Pathak",
    position: "National Chief Coordinator",
    expertise: "Administration & Coordination",
    image: board12,
    email: "sarita.pathak@nhrwwo.org",
  },
  {
    name: "Babita Devi",
    position: "National Vice Secretary",
    expertise: "Secretarial & Documentation",
    image: board13,
    email: "babita.devi@nhrwwo.org",
  },
  {
    name: "Neetu Kumari",
    position: "National Counsellor",
    expertise: "Counseling & Guidance",
    image: board14,
    email: "neetu.kumari@nhrwwo.org",
  },
  {
    name: "Nidhi Rai",
    position: "National Executive President",
  ...
  },
  {
    ...
    expertise: "Legal & Compliance",
    image: board16,
    email: "akhilesh.kumar@nhrwwo.org",
  },
      ...
      <section className="relative py-28 bg-white border-b border-zinc-150 bg-noise">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-left">
          <div className="max-w-4xl space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif font-black tracking-tight text-foreground leading-none text-balance animate-fade-in-up">
              Meet the <span className="italic text-primary font-normal">team</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground font-sans font-light leading-relaxed text-balance max-w-3xl animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
              Passionate professionals, board of directors, youth leaders, and grassroots workers dedicated to protecting human rights and supporting welfare programs across India.
            </p>
          </div>
        </div>
      </section>
