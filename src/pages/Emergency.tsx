...
**Report Submitted:** ${new Date().toLocaleString()}
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden pt-12">
      ...
      <section className="py-4 bg-primary text-white text-center font-display font-bold text-xs uppercase tracking-widest bg-noise z-50 relative">
        <div className="container mx-auto px-4 flex items-center justify-center gap-2">
          <AlertTriangle className="h-4.5 w-4.5 animate-pulse" />
          <span>If you are in immediate danger, dial 100 or call +91-79924 81330</span>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-left">
          <div className="max-w-4xl space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif font-black tracking-tight text-foreground leading-none text-balance animate-fade-in-up">
              Crisis & <span className="italic text-primary font-normal">rescue</span> support
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground font-sans font-light leading-relaxed text-balance max-w-3xl animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
              We provide 24/7 crisis support, legal intervention, and protective shelters for women, children, and victims of violence or human rights abuses.
            </p>
          </div>
        </div>
      </section>
